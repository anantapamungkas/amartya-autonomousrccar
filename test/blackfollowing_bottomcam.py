...
# Get black mask from grayscale threshold + inversion
...
def perspective_transform(image):
    tl, bl, tr, br = (118, 153), (144, 480), (505, 167), (640, 467)
...
if __name__ == "__main__":
    ...
    try:
        while True:
            ...
            # --- Bilateral Filter
            filtered = cv2.bilateralFilter(color_image, d=9, sigmaColor=75, sigmaSpace=75)
